...
// import { primaryTheme } from "../../styles/colors";
...
export default function MainPage() {
  ...
  const showIcons(index) {
    switch(index) {
      case 1: <EditRoundedIcon />
      case 2: <EditRoundedIcon />
      case 3: <EditRoundedIcon />
      case 4: <EditRoundedIcon />
      default: <EditRoundedIcon />
    }
  }
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          {["Create your habit", "Habbits list", "Send email", "Drafts"].map(
            (text, index) => (
